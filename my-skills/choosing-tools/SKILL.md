---
name: choosing-tools
description: Routes to the right tool/library choices based on project type (web, JS CLI, JS library, Rust). Load when starting a new project or selecting dependencies.
---
