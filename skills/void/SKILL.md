---
name: void
description: Provide void's document path locally. Load it when you are in a project built with void (has void.json)
---
...
I probably use Void as a replacement of transitional Nuxt mostly, I also use it with Vue 3 and TypeScript most of the time.
